...
if (NOT PICO_SDK_PATH) # checks if SDK path sin't set
    if (PICO_SDK_FETCH_FROM_GIT) # checks if auto-download is enabled
        ...
        if (PICO_SDK_FETCH_FROM_GIT_PATH) # checks if custom download location is set
            get_filename_component(FETCHCONTENT_BASE_DIR "${PICO_SDK_FETCH_FROM_GIT_PATH}" REALPATH BASE_DIR "${CMAKE_SOURCE_DIR}") #sets custom path as download path
        endif()
        ...
        message(FATAL_ERROR # if auto download disabled prints fatal error message
...
set(PICO_SDK_PATH ${PICO_SDK_PATH} CACHE PATH "Path to the SDK" FORCE)
